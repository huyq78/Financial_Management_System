...
$('body').append('' +
    '<div class="fixed-button">' + '<a href="/income" class="btn btn-md btn-primary">' + '<i class="fa-solid fa-circle-plus" aria-hidden="true"></i>Income' +
    '</a> ' + '</div>' + '');
$('body').append('' +
    '<div class="fixed-button2">' + '<a href="/expense" class="btn btn-md btn-danger">' + '<i class="fa-solid fa-circle-plus" aria-hidden="true"></i>Expense' +
    '</a> ' + '</div>' + '');
var $window = $(window);
var nav = $('.fixed-button');
var nav2 = $('.fixed-button2');
$window.scroll(function () {
